...
public class TestClient {
    ...
    {
        return clientOne.toString();
    }

    /**
     * tests all associated "get" functions.
     */
    public boolean testGets()
    {
        return ((clientOne.getHostName() == "localhost") && (clientOne.getUserName() == "Anonymous") && (clientOne.getPort() == 7000));
    }
    ...
    {
        return (clientOne.hashCode() == clientTwo.hashCode()) != (clientOne.hashCode() == clientThree.hashCode());
    }
